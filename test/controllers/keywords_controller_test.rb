...
class KeywordsControllerTest < ActionController::TestCase
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post :create, keyword: { description: @keyword.description, displayUrl: @keyword.displayUrl, title: @keyword.title }
    end
  ...
  test "should update keyword" do
    patch :update, id: @keyword, keyword: { description: @keyword.description, displayUrl: @keyword.displayUrl, title: @keyword.title }
    assert_redirected_to keyword_path(assigns(:keyword))
  end
